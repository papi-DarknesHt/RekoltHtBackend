...
CORS_ALLOWED_ORIGINS = ["http://localhost:5173","https://rekolthtfront.onrender.com","http://192.168.1.4:5173",'crudely-bounce-universal.ngrok-free.dev']
...
CSRF_TRUSTED_ORIGINS = ["http://localhost:5173","https://rekolthtfront.onrender.com/","http://192.168.1.4:5173","https://crudely-bounce-universal.ngrok-free.dev"]
...
# etc., voir CHATBOT_IA_MODEL_OPENROUTER ci-dessous) — obtenue sur
# https://openrouter.ai. Fournisseur PRINCIPAL. Laisser vide (et GEMINI_API_KEY
# aussi vide) désactive l'assistant IA : ChatbotVendeur.jsx dégrade alors
...
# tarifs de chacun
CHATBOT_IA_MODEL_OPENROUTER = os.getenv('CHATBOT_IA_MODEL_OPENROUTER', 'openai/gpt-4o')

# clé API Gemini (Google AI Studio) — obtenue sur https://aistudio.google.com.
# Fournisseur de SECOURS, utilisé automatiquement quand OpenRouter est à quota
# (HTTP 429) ou quand OPENROUTER_API_KEY n'est pas configurée.
GEMINI_API_KEY = os.getenv('GEMINI_API_KEY')
# modèle Gemini utilisé (ex. "gemini-2.5-flash", "gemini-2.5-pro"...), voir
# https://ai.google.dev/gemini-api/docs/models
CHATBOT_IA_MODEL_GEMINI = os.getenv('CHATBOT_IA_MODEL_GEMINI', 'gemini-flash-latest')
