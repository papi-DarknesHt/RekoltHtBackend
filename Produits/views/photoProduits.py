...
from Registration.services.upload_validation_service import valider_fichier_upload_django
...
def ajouterPhotosProduit(request):
    ...
    # taille + contenu réellement décodable comme image, AVANT tout écriture
    # en base (voir Registration/services/upload_validation_service.py,
    # trouvé lors d'un audit de sécurité — Django n'exécute jamais cette
    # validation automatiquement)
    try:
        for fichier in fichiers:
            valider_fichier_upload_django(fichier)
