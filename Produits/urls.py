...
urlpatterns = [
    ...
    path('statistiques/rapport-pdf/', views.statistiquesVendeurPdf),     # GET    — rapport statistique PDF (vendeur connecté)
    path('vendeur/statistiques-vues/', views.statistiquesVuesVendeur),   # GET    — vues profil/produits/catégories par période (vendeur connecté, défaut 7j)
    ...
    path('vendeurs-publics/',      views.listerVendeursPublics),         # GET    — tous les vendeurs, pour le carousel "Nos vendeurs" (public)
    ...
    path('admin/supprimer/',       views.supprimerProduitAdmin),         # DELETE — supprime définitivement n'importe quel produit (admin)
    ...
    path('signalements/traites/',      views.listerSignalementsTraites), # GET    — historique des signalements traités (admin)
    path('signalements/traites/supprimer/', views.supprimerHistoriqueSignalements), # DELETE — supprime des entrées de l'historique (admin)
    path('signalements/rapport-audit/', views.genererRapportSignalements), # GET — rapport PDF audit, 4 types confondus (?date_debut=&date_fin=&admin_id=), Tous les droits/propriétaire
    ...
    path('signalements-vendeurs/traites/',     views.listerSignalementsVendeursTraites), # GET — historique des signalements vendeur traités (admin)
    path('signalements-vendeurs/traites/supprimer/', views.supprimerHistoriqueSignalementsVendeurs), # DELETE — supprime des entrées de l'historique (admin)
    ...
    path('avis/recus/',      views.listerAvisRecusVendeur),  # GET — tous les avis reçus sur mes produits (vendeur connecté)
    ...
    path('avis/signalements/traites/',      views.listerSignalementsAvisTraites), # GET — historique des signalements d'avis traités (admin)
    path('avis/signalements/traites/supprimer/', views.supprimerHistoriqueSignalementsAvis), # DELETE — supprime des entrées de l'historique (admin)
