...
def uploader_sauvegarde(contenu_chiffre: bytes, nom_fichier: str) -> str:
    ...
    return _envoyer_par_blocs_avec_reprise(session_uri, contenu_chiffre)
...
def _envoyer_par_blocs_avec_reprise(session_uri: str, contenu: bytes, tentatives_max: int = 5) -> str:
    ...
    tout recommencer — voir uploader_sauvegarde ci-dessus."""
